...
// without this the app would only ever show fresh GMP/price data right
// after a manual pull-to-refresh — auto-refetching while the screen is
// open keeps it visibly live without over-polling the backend.
